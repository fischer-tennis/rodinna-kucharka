const CACHE='rodinna-kucharka-v2-0-3-stable';
const CORE=['./','index.html','style.css?v=2.0.3','app.js?v=2.0.3','recipes.json','manifest.json','icons/icon-32.png','icons/icon-96.png','icons/icon-180.png','icons/icon-192.png','icons/icon-512.png'];
