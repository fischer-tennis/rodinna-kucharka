const CACHE='rodinna-kucharka-v121-auth-redirect';
const CORE=['./','index.html','style.css?v=121','app.js?v=121','recipes.json','manifest.json','icons/icon-32.png','icons/icon-96.png','icons/icon-180.png','icons/icon-192.png','icons/icon-512.png'];
