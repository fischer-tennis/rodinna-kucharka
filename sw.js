const CACHE='rodinna-kucharka-v130-ai-prepis';
const CORE=['./','index.html','style.css?v=130','app.js?v=130','recipes.json','manifest.json','icons/icon-32.png','icons/icon-96.png','icons/icon-180.png','icons/icon-192.png','icons/icon-512.png'];
